...
describe("formatGithub", () => {
  it("emits one workflow command per occurrence with escaped properties", () => {
    ...
    expect(out[5]).toBe("::warning title=cssert%3A parse warning (selector-parse)::bad selector");
    expect(out[6]).toBe(
